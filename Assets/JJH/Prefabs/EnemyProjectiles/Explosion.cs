...
public class Explosion : MonoBehaviour
{
    ...
    private WaitForSeconds explosionWait = new WaitForSeconds(0.7f); // 폭발 대기 시간
    ...
    private WaitForSeconds collideriDisableTime = new WaitForSeconds(0.4f); // 폭발 콜라이더 비활성화 시간
